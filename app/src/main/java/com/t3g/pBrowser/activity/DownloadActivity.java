...
import static com.t3g.pBrowser.activity.TabActivity.PREFERENCES;
import static com.t3g.pBrowser.activity.TabActivity.WEB_LINKS;
import static com.t3g.pBrowser.activity.TabActivity.WEB_TITLE;
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (o instanceof Map) {
                    Map map = (Map) o;
//                    Intent in = new Intent(DownloadActivity.this, TabActivity.class);
//                    in.putExtra("abc", String.valueOf(map.get(TAG_LINK)));
//                    startActivity(in);
//                    String abc = String.valueOf(map.get(TAG_LINK));
                    Intent intent = new Intent(DownloadActivity.this, TabActivity.class);
                    intent.putExtra("query", String.valueOf(map.get(TAG_LINK)));
                    startActivity(intent);
//                    Toast.makeText(DownloadActivity.this, abc, Toast.LENGTH_SHORT).show();
                }
    ...
    private class LoadDownloads extends AsyncTask<String, String, String> {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if (jsonLink != null && jsonTitle != null) {
                        ...
                        adapter = new SimpleAdapter(DownloadActivity.this,
